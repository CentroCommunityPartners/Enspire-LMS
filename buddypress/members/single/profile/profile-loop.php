		...
		if ( bp_profile_group_has_fields() ) :
			...
			<div class="group-separator-block">
				<header class="entry-header profile-loop-header profile-header flex align-items-center">
					<h1 class="entry-title bb-profile-title 789"><?php bp_the_profile_group_name(); ?></h1>

					<?php
					if ( bp_is_my_profile() ) {
						?>
						<a href="<?php echo esc_url( $edit_profile_link . bp_get_the_profile_group_id() ); ?>" class="push-right button outline small"><?php esc_attr_e( 'Edit Profile', 'buddyboss-theme' ); ?></a>
						<?php
					}
					?>
				</header>
